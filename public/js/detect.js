...
console.log(ua);
const instructionsUpload = document.querySelector('.responsive-instruction-upload');
var OSName = "Unknown OS";
if (navigator.userAgent.indexOf("Win") != -1) OSName = "Windows";
if (navigator.userAgent.indexOf("Mac") != -1) OSName = "Macintosh";
if (navigator.userAgent.indexOf("Linux") != -1) OSName = "Linux";
if (navigator.userAgent.indexOf("Android") != -1) OSName = "Android";
if (navigator.userAgent.indexOf("like Mac") != -1) OSName = "iOS"; // document.write('Your OS: '+OSName);

if (navigator.userAgent.indexOf("Win") != -1) {
  instructionsUpload.textContent = 'Windows file!';
}

if (navigator.userAgent.indexOf("Mac") != -1) {
  instructionsUpload.textContent = 'This is a MacOS';
}

if (navigator.userAgent.indexOf("Linux") != -1) {
  instructionsUpload.textContent = 'Linuxxx';
}

if (navigator.userAgent.indexOf("Android") != -1) {
  instructionsUpload.textContent = 'ANDROIDDDD';
}

if (navigator.userAgent.match(/Android/i)) {
  instructionsUpload.textContent = 'this is an android phoneeee';
}

if (navigator.userAgent.match(/iPhone/i)) {
  instructionsUpload.textContent = 'this is an iphoneeee';
}

var device = detect.parse(navigator.userAgent);
if (navigator.userAgent.match("iPhone") != -1) device = "iPhone";
if (navigator.userAgent.match("Android") != -1) device = "Android";